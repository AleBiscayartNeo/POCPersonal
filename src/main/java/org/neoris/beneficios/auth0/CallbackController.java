...
/**
 * Controller encargado de interceptar el callback de login y y obtener el
 * access_token.
 * 
 * @author marcos.dip
 *
...
public class CallbackController {
	...
	/*
	 * Intercepta el callback por GET
	 */
	...
	/*
	 * Intercepta el callback por POST
	 */
	...
	private Tokens mergeTokens(Tokens tokens, Tokens latestTokens) {
		String accessToken = latestTokens.getAccessToken() != null ? latestTokens.getAccessToken()
				: tokens.getAccessToken();
		String idToken = latestTokens.getIdToken() != null ? latestTokens.getIdToken() : tokens.getIdToken();
		String refreshToken = latestTokens.getRefreshToken() != null ? latestTokens.getRefreshToken()
	...
	/**
	 * Invoca el servicio /token para obtener un access_token a partir del code
	 * 
	 * @param code
	 * @param redirectUri
	 * @return
